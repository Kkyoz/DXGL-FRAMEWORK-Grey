...
void SceneModel::Init()
{
	...
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere("Sphere", glm::vec3(1.f, 1.f, 1.f), 1.f, 6, 6);

	// Without texture
	meshList[GEO_MODEL2] = MeshBuilder::GenerateOBJMTL("model2", "OBJ//house_type01.obj",
		"OBJ//house_type01.mtl");

	// With texture
	meshList[GEO_MODEL3] = MeshBuilder::GenerateOBJMTL("model3", "OBJ//cottage_obj.obj",
		"OBJ//cottage_obj.mtl"); //cottage_diffuse
	meshList[GEO_MODEL3]->textureID = LoadTGA("Image//cottage_diffuse.tga");
...
void SceneModel::Render()
{
	...
	meshList[GEO_MODEL2]->material.kAmbient = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kDiffuse = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kSpecular = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kShininess = 1.0f;
	...
	meshList[GEO_MODEL3]->material.kAmbient = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL3]->material.kDiffuse = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL3]->material.kSpecular = glm::vec3(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL3]->material.kShininess = 1.0f;
